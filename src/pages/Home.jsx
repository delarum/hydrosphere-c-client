  ...
  return (
    <>
      ...
      <div className="home-page">
        {" "}
        {/* CRITICAL: This wrapper scopes all styles */}
        {/* Hero */}
          ...
          <div className="hero-overlay">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                A community-driven company commited to restoring large water
          ...
          <div className="map-wrapper">
            <div className="section-header">
              ...
              <p>
                ...
                our resourses in partnership with the Nairobi County Government
                and several NGOs to monitor, treat, restore an put further
